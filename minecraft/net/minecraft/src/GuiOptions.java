...
public class GuiOptions extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(186, this.width / 2 + 5, this.height / 6 + 95 - 35, 150, 20, var1.translateKey("Other")));
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        if (par1GuiButton.enabled)
        {
            ...
            if (par1GuiButton.id == 186)
            {
                this.mc.gameSettings.saveOptions();
                this.mc.displayGuiScreen(new GuiOther(this, this.options));
            }
