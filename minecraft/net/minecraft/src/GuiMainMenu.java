...
//import minecraft.net.minecraft.src.GuiButton;
//import minecraft.net.minecraft.src.MathHelper;
//import minecraft.net.minecraft.src.Tessellator;
...
public class GuiMainMenu extends GuiScreen
{
    ...
    private void addSingleplayerMultiplayerButtons(int par1, int par2, StringTranslate par3StringTranslate)
    {
        ...
        this.buttonList.add(new GuiButton(27, this.width / 2 - 100, par1 + par2 * 2,par3StringTranslate.translateKey("Mods and Texture Packs")));
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100,  par1 + par2 * 3, par3StringTranslate.translateKey("menu.options")));
    }
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        {
        	 this.mc.displayGuiScreen(new GuiTexturePacks(this, null));
        }
 ...
 /*   private void drawPanorama(int par1, int par2, float par3)
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
       ...
       /* this.drawGradientRect(0, 0, this.width, this.height, -2130706433, 16777215);
        ...
        String var10 = "Copyright Mojang Specifications. Do not distribute!";
...
*/
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        GL11.glPopMatrix();
        drawString(fontRenderer, "Minecraft 1.5.1", 2, 2, 0x505050);
